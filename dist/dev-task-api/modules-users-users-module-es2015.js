...
/* harmony import */ var _table_table_layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./table/table.layout */ "./src/app/modules/shared/table/table.layout.ts");
/* harmony import */ var _table_directive_style_cell_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./table/directive/style-cell.directive */ "./src/app/modules/shared/table/directive/style-cell.directive.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _table_table_layout__WEBPACK_IMPORTED_MODULE_3__["TableLayout"],
            _table_directive_style_cell_directive__WEBPACK_IMPORTED_MODULE_4__["StyleCellDirective"]
        ],
        imports: [
...
], StyleCellDirective.prototype, "appStyleCell", void 0);
StyleCellDirective = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _model_columnmap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/columnmap */ "./src/app/modules/shared/table/model/columnmap.ts");



let TableLayout = class TableLayout {
    constructor() { }
    ngOnInit() { }
    ngOnChanges() {
        if (this.settings) {
            this.columnMaps = this.settings
                .map(col => new _model_columnmap__WEBPACK_IMPORTED_MODULE_2__["ColumnMap"](col));
        }
        else {
            this.columnMaps = Object.keys(this.contents[0])
                .map(key => {
                return new _model_columnmap__WEBPACK_IMPORTED_MODULE_2__["ColumnMap"]({ primaryKey: key });
            });
        }
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TableLayout.prototype, "contents", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], TableLayout.prototype, "settings", void 0);
TableLayout = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-table',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./table.layout.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/shared/table/table.layout.html")).default
    })
], TableLayout);
...
CreateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./create.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/users/create/create.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./create.component.css */ "./src/app/modules/users/create/create.component.css")).default]
    })
], CreateComponent);
...
let EditComponent = class EditComponent {
    constructor(route, usersService, router) {
        this.route = route;
        this.usersService = usersService;
        this.router = router;
    }
...
EditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-edit',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/users/edit/edit.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit.component.css */ "./src/app/modules/users/edit/edit.component.css")).default]
    })
], EditComponent);
...
let UsersPage = class UsersPage {
    ...
    getUsers() {
        return this.usersService.getUsers(this.page)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((users) => {
            this.users = users.data;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((users) => this.getTotalPages(users.last_page)))
            .subscribe();
    }
...
UsersPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-users',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./users.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/users/page/users.page.html")).default
    })
], UsersPage);
...
/* harmony import */ var _page_users_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./page/users.page */ "./src/app/modules/users/page/users.page.ts");
/* harmony import */ var _create_create_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./create/create.component */ "./src/app/modules/users/create/create.component.ts");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _users_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./users-routing.module */ "./src/app/modules/users/users-routing.module.ts");
/* harmony import */ var _page_users_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./page/users.page */ "./src/app/modules/users/page/users.page.ts");
...
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit/edit.component */ "./src/app/modules/users/edit/edit.component.ts");
/* harmony import */ var _create_create_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./create/create.component */ "./src/app/modules/users/create/create.component.ts");
...
UsersModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _page_users_page__WEBPACK_IMPORTED_MODULE_4__["UsersPage"],
...
let UsersService = class UsersService {
    ...
    getUsers(page) {
        return this.httpClient.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/users?page=${page}`);
    }
    createUser(user) {
        return this.httpClient.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/users/create`, user);
    }
    updateUser(userId, user) {
        return this.httpClient.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/users/${userId}`, user);
    }
    showUser(userId) {
        return this.httpClient.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/users/${userId}`);
    }
};
